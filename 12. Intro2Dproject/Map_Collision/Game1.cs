...
namespace Map_Collision
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            {
                SaveGame sg = SaveGame.LoadGameX("savegame");
                GameStuff.Instance.player = new Player(Content.Load<Texture2D>("human"), sg.playerPosition, 1f, 100f, animatedSprite);
            }
            else
            {
            ...
            GameStuff.Instance.cutsceneBeacon = new CutsceneBeacon(new Vector2(700, 1100), 100, new List<CutsceneController.MoveOrder>()
            {
                new CutsceneController.MoveOrder(CutsceneController.MoveControlls.Left, 300),
                new CutsceneController.MoveOrder(CutsceneController.MoveControlls.Jump, 200),
                new CutsceneController.MoveOrder(CutsceneController.MoveControlls.Right, 800)
        ...
        protected override void Update(GameTime gameTime)
        {
            if (GamePad.GetState(PlayerIndex.One).Buttons.Back == ButtonState.Pressed || Keyboard.GetState().IsKeyDown(Keys.Escape))
            {
                ...
                SaveGame sg = new SaveGame(GameStuff.Instance.player.position);

                SaveGame.SaveX(sg, "savegame");
            }
            // TODO: Add your update logic here
            GameStuff.Instance.tileMap.Update(gameTime);
            GameStuff.Instance.cutsceneBeacon.Update();
